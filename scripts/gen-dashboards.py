...
cluster = dashboard("k3s-cluster-overview", "k3s Cluster Overview", [
    ...
    stat("Pods not Running", 'sum(kube_pod_status_phase{phase=~"Pending|Failed|Unknown"}) or vector(0)', th=GREEN_RED(1),
         desc="Pending, Failed or Unknown pods. Completed jobs are not counted."),
